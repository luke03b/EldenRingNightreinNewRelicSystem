// ItemsMapping.js
// Mapping of item IDs to their names and colors
// Based on nightreign-relic-browser-main/src/resources/items.ts
...
const ItemsMapping = (() => {
  ...
  const itemsArray = [
    { key: 'besmirchedFrame', color: RelicColor.Blue, ids: [10001], type: ItemType.UniqueRelic },
    { key: 'blackClawNecklace', color: RelicColor.Yellow, ids: [15002], type: ItemType.UniqueRelic },
    { key: 'bladeOfNightFragment', color: null, ids: [16000], type: ItemType.Misc },
    { key: 'blessedFlowers', color: RelicColor.Green, ids: [18000], type: ItemType.UniqueRelic },
    { key: 'blessedIronCoin', color: RelicColor.Green, ids: [14002], type: ItemType.UniqueRelic },
    { key: 'boneLikeStone', color: RelicColor.Green, ids: [17002], type: ItemType.UniqueRelic },
    { key: 'crackedSealingWax', color: RelicColor.Yellow, ids: [13001], type: ItemType.UniqueRelic },
    { key: 'crackedWitchsBrooch', color: RelicColor.Blue, ids: [12003], type: ItemType.UniqueRelic },
    { key: 'crownMedal', color: RelicColor.Green, ids: [14001], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheBaron', color: RelicColor.Red, ids: [2011], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheBeast', color: RelicColor.Yellow, ids: [2001], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheChampion', color: RelicColor.Yellow, ids: [2051], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheDemon', color: RelicColor.Blue, ids: [2041], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheFathom', color: RelicColor.Blue, ids: [2031], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheMiasma', color: RelicColor.Green, ids: [2061], type: ItemType.UniqueRelic },
    { key: 'darkNightOfTheWise', color: RelicColor.Green, ids: [2021], type: ItemType.UniqueRelic },
    {
      key: 'delicateBurningScene',
      color: RelicColor.Red,
      ids: [100, 103, 106, 200, 203, 206, 1000, 11003, 11004, 20000, 20003, 20006,
    ...
    },
    {
      ...
      ids: [109, 112, 115, 209, 212, 215, 1010, 12005, 12006, 19080, 20009, 20012,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [118, 121, 124, 218, 221, 224, 1020, 1050, 12004, 17160, 19160, 20018,
        ...
        1007200, 1007210, 1007220, 1008200, 1008210, 1008220, 1009200, 1009210, 1009220],
      type: ItemType.Relic
    },
    {
      key: 'delicateTranquilScene',
      color: RelicColor.Green,
      ids: [127, 130, 133, 227, 230, 233, 1030, 12007, 20027, 20030, 20033, 1000300,
    ...
    { key: 'edgeOfOrder', color: RelicColor.Yellow, ids: [13002], type: ItemType.UniqueRelic },
    { key: 'fellOmenFetish', color: RelicColor.Blue, ids: [10002], type: ItemType.UniqueRelic },
    { key: 'fineArrowhead', color: null, ids: [13000], type: ItemType.Misc },
    { key: 'goldenDew', color: RelicColor.Yellow, ids: [14000], type: ItemType.UniqueRelic },
    { key: 'goldenShell', color: null, ids: [18001], type: ItemType.Misc },
    { key: 'goldenSprout', color: RelicColor.Red, ids: [18002], type: ItemType.UniqueRelic },
    {
      key: 'grandBurningScene',
      color: RelicColor.Red,
      ids: [102, 105, 108, 202, 205, 208, 1180, 1250, 1260, 1300, 1410, 1440, 1480,
    ...
    },
    {
      ...
      color: RelicColor.Blue,
      ids: [111, 114, 117, 211, 214, 217, 1190, 1230, 1240, 1400, 1460, 1520, 1610,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [120, 123, 126, 220, 223, 226, 1210, 1220, 1450, 1470, 1510, 1600, 1630,
    ...
    },
    {
      ...
      color: RelicColor.Green,
      ids: [129, 132, 135, 229, 232, 235, 1200, 1270, 1310, 1420, 1430, 1490, 1620,
    ...
    { key: 'largeScenicFlatstone', color: null, ids: [30], type: ItemType.Misc },
    { key: 'nightOfTheBaron', color: RelicColor.Blue, ids: [2010], type: ItemType.UniqueRelic },
    { key: 'nightOfTheBeast', color: RelicColor.Green, ids: [2000], type: ItemType.UniqueRelic },
    { key: 'nightOfTheChampion', color: RelicColor.Green, ids: [2050], type: ItemType.UniqueRelic },
    { key: 'nightOfTheDemon', color: RelicColor.Red, ids: [2040], type: ItemType.UniqueRelic },
    { key: 'nightOfTheFathom', color: RelicColor.Red, ids: [2030], type: ItemType.UniqueRelic },
    { key: 'nightOfTheLord', color: RelicColor.Blue, ids: [2100], type: ItemType.UniqueRelic },
    { key: 'nightOfTheMiasma', color: RelicColor.Yellow, ids: [2060], type: ItemType.UniqueRelic },
    { key: 'nightOfTheWise', color: RelicColor.Yellow, ids: [2020], type: ItemType.UniqueRelic },
    { key: 'nightShard', color: null, ids: [17000], type: ItemType.Misc },
    { key: 'oldPocketwatch', color: RelicColor.Green, ids: [10000], type: ItemType.UniqueRelic },
    { key: 'oldPortrait', color: RelicColor.Blue, ids: [16002], type: ItemType.UniqueRelic },
    {
      key: 'polishedBurningScene',
      color: RelicColor.Red,
      ids: [101, 104, 107, 201, 204, 207, 1040, 1080, 1110, 1120, 16961, 16971, 17961,
    ...
    },
    {
      ...
      color: RelicColor.Blue,
      ids: [110, 113, 116, 210, 213, 216, 1070, 1160, 1170, 17061, 17071, 17081,
        ...
        1002121, 1003101, 3111, 1003121, 1004101, 1004111, 1004121, 1005101,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [119, 122, 125, 219, 222, 225, 1140, 1150, 17171, 17181, 18161, 18171,
        ...
        1007201, 1007211, 1007221, 1008201, 1008211, 1008221, 1009201, 1009211, 1009221],
      type: ItemType.Relic
    },
    {
      key: 'polishedTranquilScene',
      color: RelicColor.Green,
      ids: [128, 131, 134, 228, 231, 234, 1060, 1090, 1100, 1130, 17261, 17271, 17281,
        ...
        1000321, 1001301, 1001311, 1001321, 1002301, 2311, 1002321, 1003301,
    ...
    { key: 'scenicFlatstone', color: null, ids: [20], type: ItemType.Misc },
    { key: 'silverTear', color: RelicColor.Red, ids: [11002], type: ItemType.UniqueRelic },
    { key: 'slateWhetstone', color: RelicColor.Red, ids: [11000], type: ItemType.UniqueRelic },
    { key: 'smallMakeupBrush', color: RelicColor.Blue, ids: [16001], type: ItemType.UniqueRelic },
    { key: 'sovereignSigil', color: null, ids: [11], type: ItemType.Misc },
    { key: 'stoneStake', color: RelicColor.Red, ids: [12001], type: ItemType.UniqueRelic },
    { key: 'theWyldersEarring', color: RelicColor.Red, ids: [11001], type: ItemType.UniqueRelic },
    { key: 'thirdVolume', color: RelicColor.Red, ids: [12000], type: ItemType.UniqueRelic },
    { key: 'tornBraidedCord', color: RelicColor.Blue, ids: [15000], type: ItemType.UniqueRelic },
    { key: 'vestigeOfNight', color: RelicColor.Green, ids: [17001], type: ItemType.UniqueRelic },
    { key: 'witchsBrooch', color: RelicColor.Blue, ids: [12002], type: ItemType.UniqueRelic },
    {
      key: 'deepDelicateBurningScene',
      color: RelicColor.Red,
      ids: [30000, 30003, 30006, 2000000, 2000010, 2000020, 2003000, 2003010, 2003020,
    ...
    },
    {
      ...
      color: RelicColor.Red,
      ids: [30001, 30004, 30007, 2000001, 2000011, 2000021, 2001001, 2001011, 2001021,
    ...
    },
    {
      ...
      color: RelicColor.Red,
      ids: [30002, 30005, 30008, 2000002, 2000012, 2000022, 2001002, 2001012, 2001022,
    ...
    },
    {
      ...
      color: RelicColor.Blue,
      ids: [30009, 30012, 30015, 2000100, 2000110, 2000120, 2003100, 2003110, 2003120,
    ...
    },
    {
      ...
      color: RelicColor.Blue,
      ids: [30010, 30013, 30016, 2000101, 2000111, 2000121, 2001101, 2001111, 2001121,
    ...
    },
    {
      ...
      color: RelicColor.Blue,
      ids: [30011, 30014, 30017, 2000102, 2000112, 2000122, 2001102, 2001112, 2001122,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [30018, 30021, 30024, 2000200, 2000210, 2000220, 2003200, 2003210, 2003220,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [30019, 30022, 30025, 2000201, 2000211, 2000221, 2001201, 2001211, 2001221,
    ...
    },
    {
      ...
      color: RelicColor.Yellow,
      ids: [30020, 30023, 30026, 2000202, 2000212, 2000222, 2001202, 2001212, 2001222,
    ...
    },
    {
      ...
      color: RelicColor.Green,
      ids: [30027, 30030, 30033, 2000300, 2000310, 2000320, 2003300, 2003310, 2003320,
    ...
    },
    {
      ...
      color: RelicColor.Green,
      ids: [30028, 30031, 30034, 2000301, 2000311, 2000321, 2001301, 2001311, 2001321,
    ...
    },
    {
      ...
      color: RelicColor.Green,
      ids: [30029, 30032, 30035, 2000302, 2000312, 2000322, 2001302, 2001312, 2001322,
    ...
    { key: 'theWillOfTheBalancers', color: RelicColor.Blue, ids: [2070], type: ItemType.UniqueRelic },
    { key: 'theNightOfDregs', color: RelicColor.Red, ids: [2080], type: ItemType.UniqueRelic },
    { key: 'cleansingTear', color: RelicColor.Red, ids: [19000], type: ItemType.UniqueRelic },
    { key: 'noteMyDearSuccessor', color: RelicColor.Yellow, ids: [19001], type: ItemType.UniqueRelic },
    { key: 'theWillOfTheBalance', color: RelicColor.Red, ids: [2071], type: ItemType.UniqueRelic },
    { key: 'leatherMonocleCase', color: RelicColor.Blue, ids: [19050], type: ItemType.UniqueRelic },
    { key: 'glassNecklace', color: RelicColor.Green, ids: [19051], type: ItemType.UniqueRelic }
  ];
  ...
  itemsArray.forEach(item => {
    item.ids.forEach(id => {
      if (itemsMap.has(id)) {
        console.warn(`Duplicate item ID ${id} for key "${item.key}". Already set by "${itemsMap.get(id).key}".`);
      }
