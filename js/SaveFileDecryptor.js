...
class SaveFileDecryptor {
   ...
   */
  static readInt32LE(data, offset) {
    return (
      data[offset] |
      (data[offset + 1] << 8) |
      (data[offset + 2] << 16) |
   ...
   */
  static arrayStartsWith(data, pattern) {
   ...
   */
  static async decryptSaveFile(fileBuffer) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = SaveFileDecryptor;
}
