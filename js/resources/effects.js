(function() {
  ...
  // Check dependencies
  if (typeof window.EffectKey === "undefined") {
    throw new Error("EffectKey must be loaded before effects.js");
  }
  if (typeof window.Nightfarer === "undefined") {
    throw new Error("Nightfarer must be loaded before effects.js");
  }

  const EffectKey = window.EffectKey;
  const Nightfarer = window.Nightfarer;

  const StartingBonus = {
    ArmamentsSkill: 0,
    ElementalInfusion: 1,
  };
  Object.freeze(StartingBonus);

  const EffectGroup = {
    arcane: 0,
    attacksInflictBloodLoss: 1,
    attacksInflictFrost: 2,
    attacksInflictPoison: 3,
    attacksInflictScarletRot: 4,
    attacksInflictSleep: 5,
    characterSkillCooldownReduction: 6,
    dexterity: 7,
    endurance: 8,
    faith: 9,
    fireAttackPowerUp: 10,
    holyAttackPowerUp: 11,
    improvedCriticalHits: 12,
    improvedGuardingAbility: 13,
    improvedStaminaRecovery: 14,
    intelligence: 15,
    lightningAttackPowerUp: 16,
    magicAttackPowerUp: 17,
    mind: 18,
    physicalAttackUp: 19,
    poise: 20,
    projectileDamageDropOffReduced: 21,
    raisesMaximumFp: 22,
    raisesNonPhysicalDamageNegation: 23,
    raisesPhysicalAttackPower: 24,
    raisesPhysicalDamageNegation: 25,
    staminaRecoveryUponLandingAttacks: 26,
    strength: 27,
    ultimateArtGauge: 28,
    vigor: 29,
    improvedMagicDamageNegation: 30,
    improvedFireDamageNegation: 31,
    improvedLightningDamageNegation: 32,
    improvedHolyDamageNegation: 33,
    improvedPoisonResistance: 34,
    improvedBloodLossResistance: 35,
    improvedSleepResistance: 36,
    improvedDeathBlightResistance: 37,
    improvedRotResistance: 38,
    improvedFrostResistance: 39,
    improvedMadnessResistance: 40,
    partialHPRestorationUponPostDamageAttacks: 41,
    hpRestoredWhenUsingMedicinalBolusesEtc: 42,
    artGaugeChargedFromSuccessfulGuarding: 43,
    artGaugeFillsModeratelyUponCriticalHit: 44,
    physicalAttackPowerIncreasesAfterUsingGreaseItems: 45,
    criticalHitBoostsStaminaRecoverySpeed: 46,
    improvedGuardCounters: 47,
    improvedThrowingPotDamage: 48,
    improvedThrowingKnifeDamage: 49,
    improvedGlintstoneAndGravityStoneDamage: 50,
    improvedRoarAndBreathAttacks: 51,
    improvedPerfumingArts: 52,
    defeatingEnemiesFillsMoreOfTheArtGauge: 53,
    hpRestorationUponThrustingCounterattack: 54,
    attackPowerUpWhenFacingPoisonAfflictedEnemy: 55,
    attackPowerUpWhenFacingScarletRotAfflictedEnemy: 56,
    attackPowerUpWhenFacingFrostbiteAfflictedEnemy: 57,
    sleepInVicinityImprovesAttackPower: 58,
    madnessInVicinityImprovesAttackPower: 59,
    reducedFPConsumption: 60,
    improvedAffinityAttackPower: 61,
    improvedPhysicalDamageNegation: 62,
    improvedAffinityDamageNegation: 63,
    improvedSorceries: 64,
    improvedIncantations: 65,
    attackPowerUpWhenFacingSleepAfflictedEnemy: 66,
  };
  Object.freeze(EffectGroup);
...
for (const effect of effectsArray) {
  ...
  function isEffectKey(input) {
  return effectsArray.some((effect) => effect.key === input);
}

  function isEffect(input) {
  return (
    typeof input === "object" &&
    input !== null &&
    "key" in input &&
  ...
  function isSameStartingBonus(effect1, effect2) {
  return (
  ...
  function isSameGroup(effect1, effect2) {
  return (
  ...
  function isSameGroupAndEqualOrBetter(effect1, effect2) {
  return (
  ...
  function hasGroupAndLevel(e) {
  return typeof e === "object" && e !== null && "group" in e && "level" in e;
}

  function isMaxLevel(effect) {
  ...
  window.effectsArray = effectsArray;
  window.effects = effects;
  window.isEffectKey = isEffectKey;
  window.isEffect = isEffect;
  window.isSameStartingBonus = isSameStartingBonus;
  window.isSameGroup = isSameGroup;
  window.isSameGroupAndEqualOrBetter = isSameGroupAndEqualOrBetter;
  window.isMaxLevel = isMaxLevel;
})();